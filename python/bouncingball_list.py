...
x_speed3 = random.randint(-10, 10)
y_speed3 = random.randint(-10, 10)
...
x_location3 = int(SCREEN_WIDTH/2)
y_location3 = int(SCREEN_HEIGHT/2)
...
while not done:
    ...
    pygame.draw.circle(screen, ball_color, [x_location3, y_location3], ball_size)
    if x_location3 >= SCREEN_WIDTH - ball_size or x_location3 < ball_size:
        x_speed3 = x_speed3 * -1

    if y_location3 >= SCREEN_HEIGHT - ball_size or y_location3 < ball_size:
        y_speed3 = y_speed3 * -1


    x_location3 += x_speed3
    y_location3 += y_speed3
