...
class Scroller(object):
	...
	def move_buildings(self):
		...
		"""
		for buildings in building_list1:
			buildings.move(self.speed)		


FRONT_SCROLLER_COLOR = (0,0,30)
MIDDLE_SCROLLER_COLOR = (30,30,100)
BACK_SCROLLER_COLOR = (50,100,150)
BACKGROUND_COLOR = (17, 9, 89)

BACK_SCROLLER_COLOR = (0,0,225)
front_scroller = Scroller(SCREEN_WIDTH, 20, SCREEN_HEIGHT, FRONT_SCROLLER_COLOR, -3)
